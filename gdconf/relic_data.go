...
type Relic struct {
	...
	MainAffixGroup uint32 `json:"hkrpgAffixGroup"`
...
func (g *GameDataConfig) loadRelic() {
	...
	//	panic(info)
	//}
	playerElementsFile, err := base64.StdEncoding.DecodeString(gameData.RelicConfig)
	if err != nil {
		logger.Error("get RelicConfig error")
		os.Exit(-1)
	}
	...
	//	panic(info)
	//}
	playerElementsFiles, err := base64.StdEncoding.DecodeString(gameData.RelicExpItem)
	if err != nil {
		logger.Error("get RelicExpItem error")
		os.Exit(-1)
	}
